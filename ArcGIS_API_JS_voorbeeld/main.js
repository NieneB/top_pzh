require([
    ...
    // var bakkenGrongingen = new WMSLayer({
    //     url: "https://geoservices.provinciegroningen.nl/arcgis/services/OpenData_OBJ/MapServer/WmsServer?",
    //     sublayers: [{
    //         name: "Afvalbakken",
    //         legendUrl: "" // url to the legend
    //     }]
    // });
    // map.layers.add(bakkenGrongingen);
